            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(ee, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(97, 97, 97)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            String sql = "insert  into Table_1(narmal) values (?)";
            PreparedStatement pst = con.prepareStatement(sql);
            //pst.setString(1, ee.getText());
            //pst.setString(1, (String) jComboBox1.getSelectedItem());
            //pst.setString(1, ((JTextField)jXDatePicker1.getDateEditor().getUiComponent()).getText());
            pst.setString(1, jXDatePicker1.getDate().toString());
            pst.executeUpdate();
